			...
			<div class="row">
         	...
         	<%
         		...
         		%>
								...
								<button type="submit" class="btn btn-primary" name="acao" value="Sim">Sim</button>
								<button type="button" onclick="carrega()" class="btn btn-default" data-dismiss="modal">N&atilde;o</button>
